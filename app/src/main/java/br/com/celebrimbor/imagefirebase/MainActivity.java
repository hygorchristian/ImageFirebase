package br.com.celebrimbor.imagefirebase;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void initComponent() {
        ...
        for (String img : array_image_product) {
            Image obj = new Image();
            obj.image = img;
            items.add(obj);
        }
    ...
    private static class AdapterImageSlider extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            StorageReference storageReference = FirebaseStorage.getInstance().getReference().child("ImageFirebase").child(o.image);
            GlideApp.with(act).load(storageReference)
